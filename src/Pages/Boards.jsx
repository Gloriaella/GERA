...
//     try {
//       const response = await databases.listDocuments("67d4f0f2003cbfbe2a79", "67d4f19d0036525e7044", [
...
//     try {
//       await databases.createDocument("67d4f0f2003cbfbe2a79", "notifications", "unique()", {
//         userId: user?.$id,
//         message,
...
//     try {
//       await databases.createDocument("67d4f0f2003cbfbe2a79", "67d4f19d0036525e7044", "unique()", taskToAdd);
//       fetchTasks();
//       setNewTask({ title: "", description: "", status: "", start_date: "", start_time: "", end_date: "", end_time: "" });
//       setShowAddTaskModal(false);
//       addNotification(`Task '${taskToAdd.title}' added.`);
//     } catch (error) {
...
//     try {
//       await databases.deleteDocument("67d4f0f2003cbfbe2a79", "67d4f19d0036525e7044", taskId);
//       fetchTasks();
//       addNotification(`Task '${taskTitle}' deleted.`);
//     } catch (error) {
...
//     try {
//       await databases.updateDocument("67d4f0f2003cbfbe2a79", "67d4f19d0036525e7044", result.draggableId, {
//         status: result.destination.droppableId,
//       });
//       addNotification(`Task moved to '${result.destination.droppableId}'.`);
//     } catch (error) {
...
//               {(provided) => (
//                 <div {...provided.droppableProps} ref={provided.innerRef} className="bg-gray-100 p-4 rounded-lg shadow-md min-h-[300px] relative">
//                   <h2 className="text-lg font-bold text-gray-700 mb-2">{status}</h2>
//                   <div className="space-y-2">
//                     {tasks.filter(task => task.status === status).map((task, index) => (
//                       <Draggable key={task.$id} draggableId={task.$id} index={index}>
//                         {(provided) => (
//                           <div ref={provided.innerRef} {...provided.draggableProps} {...provided.dragHandleProps} className="bg-white p-3 rounded-lg shadow flex justify-between items-center">
...
//                               </div>
//                             </div>
//                             <FiTrash className="text-red-500 cursor-pointer" onClick={() => handleDeleteTask(task.$id, task.title)} />
//                           </div>
//                         )}
//                       </Draggable>
//                     ))}
...
//                   </div>
//                   <button 
//                     className="absolute bottom-4 left-1/2 transform -translate-x-1/2 bg-orange-600 text-white px-3 py-2 rounded-md shadow-md hover:bg-orange-700 transition text-sm w-full" 
//                     onClick={() => {
...
// import { useState, useEffect, useContext } from "react";
// import { FiPlusCircle, FiTrash, FiBell } from "react-icons/fi";
// import { databases } from "../Appwrite/client";
// import { DragDropContext, Droppable, Draggable } from "@hello-pangea/dnd";
// import Auth from "../Context/context";
// import { Query } from "appwrite";
...
//       });
//       setShowAddTaskModal(false);
//       addNotification(`Task '${taskToAdd.title}' added to ${selectedStatus}.`);
//     } catch (error) {
//       console.error("Error adding task:", error);
//     }
//   };
...
//                   className="bg-gray-100 p-4 rounded-lg shadow-md min-h-[300px] relative"
//                 >
    ...
    <div className="p-6 space-y-6 max-w-6xl mx-auto">
      ...
      {showAddTaskModal && (
        <div className="fixed inset-0 flex mt-10 items-center justify-center backdrop-blur-xs">
          <div className="bg-orange-200 p-6 rounded-lg shadow-lg w-[400px]">
